...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/bitter-meadow-3cf8
```

A live public deployment of this template is available at [https://bitter-meadow-3cf8.templates.workers.dev](https://bitter-meadow-3cf8.templates.workers.dev)
